/*! For license information please see tutorial.a2cb726ed10a7d440094.js.LICENSE.txt */
var tutorial = (function (e) {
    ...
    function n(e, t = 0) {
      ...
      return "object" == typeof e
        ? (function (e, t = 0) {
            ...
            if ("Object" != r && e.toString != Object.prototype.toString)
              return e.toString();
            let a = "";
            "Object" != r && (a += r + " ");
            if (((a += "{"), t > 1)) a += "...";
              ...
              for (let a in e)
                e.hasOwnProperty(a) &&
                  r.push("".concat(a, ": ").concat(n(e[a], t + 1)));
              a += r.join(", ");
            }
            return (a += "}"), a;
          })(e, t)
  ...
  function (e, t, n) {
    ...
    e.exports = i;
    const s = n(1).lang;
    "en" !== s && r.setFallback(s, "en"),
      (r.add = (...e) => r.addPhrase(s, ...e)),
      (i.i18n = r);
  },
  function (e, t, n) {
    var r = n(43),
      ...
      filter(e) {
        ...
        function r(t) {
          return (function (e, t) {
            ...
            t.querySelector("a").innerHTML.toLowerCase(),
            e.replace(/\s/g, "")
          );
        }
        for (let e = 0; e < n.length; e++) {
          let a = n[e],
            i = a.querySelectorAll(".tutorial-map-list-three__item"),
            s = Array.prototype.reduce.call(
              i,
              function (e, n) {
                let a = !1;
                if (t) {
  ...
  function (module, exports, __webpack_require__) {
    const delegate = __webpack_require__(0),
      prism = __webpack_require__(12),
      ItemSlider = __webpack_require__(42);
    function init() {
      initTaskButtons(),
        initFolderList(),
        initViewMoreButton(),
  ...
  function (e, t, n) {
    ...
    function s(e) {
      !(function (e) {
        ...
        for (let e of t)
          new r(e), e.setAttribute("data-prism-highlighted", "1");
      })(e),
        (function (e) {
          let t = e.querySelectorAll(
          ...
          for (let e of t)
            new a(e), e.setAttribute("data-prism-highlighted", "1");
        })(e);
    }
    (t.init = function () {
        ...
        for (var p in n)
          if (n.hasOwnProperty(p) && n[p]) {
            ...
            for (var f = 0; f < h.length; ++f) {
              ...
              for (
                var w = g.pattern || g, _ = o.next, S = u;
                _ !== t.tail && !(d && S >= d.reach);
                S += _.value.length, _ = _.next
              ) {
                var k = _.value;
                ...
                if (!(k instanceof a)) {
                  ...
                  if (b) {
                    ...
                    var x = A.index,
                      ...
                      L = S;
                    for (L += _.value.length; x >= L; )
                      L += (_ = _.next).value.length;
                    if (((S = L -= _.value.length), _.value instanceof a))
                      continue;
                    for (
                      var O = _;
                      O !== t.tail && (L < F || "string" == typeof O.value);
                      O = O.next
                    )
                      T++, (L += O.value.length);
                  ...
                  var C = A[0],
                    I = k.slice(0, x),
                    N = k.slice(x + C.length),
                    R = S + k.length;
                  d && R > d.reach && (d.reach = R);
                  var P = _.prev;
                  I && ((P = l(t, P, I)), (S += I.length)),
                    c(t, P, T),
                    (_ = l(t, P, new a(p, m ? r.tokenize(C, m) : C, y, C))),
                    N && l(t, _, N),
                    T > 1 &&
                      s(e, t, n, _.prev, S, {
                        cause: p + "," + f,
  ...
  function (e, t, n) {
    let r = n(26),
      ...
      i = n(3);
    n(32);
    const { highlight: s } = n(33),
      o = n(1);
    let l = n(4);
    const c = n(5),
      u = n(1).lang;
    c.i18n.add("prism", n(38)("./" + u + ".yml")),
      (e.exports = function (e) {
        let t,
          n = e.querySelector("pre"),
          s = Array.from(n.childNodes).find((e) => "CODE" === e.tagName),
          u = s.textContent;
        e.codeBox = this;
        let d = u;
        ...
        h &&
          (function (e, t) {
            ...
            for (let e of t)
              if (void 0 !== e.end)
                (n[e.start] = '<em class="block-highlight">' + n[e.start]),
                  (n[e.end] += "</em>");
              else {
                let t = n[e.start],
                  r = e.cols,
                ...
                for (let e = 0; e < t.length; e++) {
                  if (("<" == t[e] && (a = !0), a)) s += t[e];
                    ...
                    if (
                      (i++,
                      r.find((e) => e.start == i) &&
                        (s += '<em class="inline-highlight">'),
                      (s += t[e]),
                      "&" == t[e])
                    ) {
                      let n = ["lt;", "gt;", "amp;", "quot;"];
                      for (let r of n)
                        t.slice(e + 1, e + 1 + r.length) == r &&
                          ((e += r.length), (s += r));
                    }
        ...
        let f,
          g,
          m,
          v = n.classList.contains("language-javascript"),
          b = n.classList.contains("language-markup"),
          y = +e.getAttribute("data-trusted"),
          E = !+e.getAttribute("data-no-strict") && v ? '"use strict";' : "",
          w = 'globalThis.__codeBoxId = "'.concat(e.id, '";'),
          _ = "".concat(E, "\n\n").concat(d);
        d = "".concat(E).concat(w, "\n\n").concat(d);
        let S = !0;
        if (!v && !b) return;
        ...
        function T() {
          ...
          "function" == typeof e.postMessage
            ? e.postMessage(d, o.lookatCodeUrlBase + "/showjs")
        ...
        function x() {
          if (e.hasAttribute("data-global")) {
            g ||
              ...
              (g.className = "js-frame"),
              (g.style.width = 0),
              (g.style.height = 0),
              (g.style.border = "none"),
              (g.name = "js-global-frame"),
              document.body.appendChild(g));
            let t = document.createElement("form");
            (t.style.display = "none"),
              (t.method = "POST"),
              (t.enctype = "multipart/form-data"),
              (t.action = o.lookatCodeUrlBase + "/showhtml"),
              (t.target = "js-global-frame");
            let n = e.hasAttribute("data-module") ? ' type="module"' : "",
            ...
            if (e.hasAttribute("data-autorun") || e.hasAttribute("data-module"))
            ...
            e.hasAttribute("data-refresh") && f && (f.remove(), (f = null)),
              f
                ? T()
                : ((f = document.createElement("iframe")),
                  (f.className = "js-frame"),
                  (f.src = o.lookatCodeUrlBase + "/showjs"),
                  (f.style.width = 0),
                  (f.style.height = 0),
                  (f.style.border = "none"),
                  (f.onload = function () {
              ...
              : (function () {
                  ...
                  if (
                    (m &&
                      ...
                      (m.remove(), (m = null)),
                    m || (m = e.querySelector(".code-result")),
                    m)
                  )
                    t = m.querySelector("iframe");
                  else {
                    if (
                      ((m = document.createElement("div")),
                      (m.className = "code-result code-example__result"),
                  ...
                  if (y && !t.hasCustomConsoleLog) {
                    ...
                    let n = t.contentWindow.console.log.bind(
                      t.contentWindow.console
                    );
                  ...
                  if (y) {
                    ...
                    (n.style.display = "none"),
                      ...
                      (n.action = o.lookatCodeUrlBase + "/showhtml"),
                      (n.target = t.name);
          ...
          (this.consoleLog = function (n) {
            if (!t) {
              (t = document.createElement("div")),
                (t.className = "codebox__output"),
                e.append(t);
              let n = document.createElement("div");
              (n.className = "codebox__output-label"),
                (n.innerHTML = c("prism.output")),
                t.append(n);
            }
            let r = document.createElement("div");
            (r.className = "codebox__output-line"),
              (r.innerHTML = n),
              t.append(r);
          });
      });
      ...
      for (let n of e) {
        ...
        if (((e += "\n".repeat(n.start)), n.end))
          ...
          for (let t = 0; t < n.cols.length; t++) {
            let r = n.cols[t],
              a = 0 === t ? null : n.cols[t - 1];
            (e += " ".repeat(a ? r.start - a.end : r.start)),
          ...
          e.hooks.add("before-highlightall", function (e) {
            ...
            (e.plugins.fileHighlight = {
              highlight: function (t) {
                for (
                  var n, r = (t || document).querySelectorAll(i), a = 0;
                  (n = r[a++]);
  ...
  function (e, t, n) {
    ...
    function p(e, t, n) {
      if (null !== e)
        if (d && e.forEach === d) e.forEach(t, n);
          ...
          for (var r = 0, a = e.length; r < a; r += 1) t.call(n, e[r], r, e);
        else
          for (var i in e)
    ...
    function f(e) {
      var t = 1,
        n = arguments,
        r = n.length,
        a = String(e).replace(h, function (e) {
          if ("%%" === e) return "%";
          if (t >= r) return e;
          switch (e) {
            case "%s":
    ...
    function b(e, t, n) {
      ...
      for (
        var s, o = e._fallbacks[t] || [e._defaultLocale], l = 0, c = o.length;
        l < c;
        l++
      )
        if (((s = v(o[l], n)), a.hasOwnProperty(s))) return (i[r] = s), i[r];
    ...
    function E(e) {
      ...
      (this._defaultLocale = e ? String(e) : "en"),
        (this._fallbacks = {}),
    ...
    (E.prototype.translate = function (e, t, n) {
      var a,
        l = b(this, e, t);
      return l
        ? (a = this._storage[l]).raw
          ? a.translation
          : (a.hasOwnProperty("compiled") ||
              (a.compiled = (function (e, t, n) {
                var a, i, s, o, l, c;
                return w.test(t)
                  ? 1 === (a = r.parse(t)).length && "literal" === a[0].type
                    ? a[0].text
                    : (e._plurals_cache[n] || (e._plurals_cache[n] = new E(n)),
                      (c = e._plurals_cache[n]),
                      (i = []).push([
                        'var str = "", strict, strict_exec, forms, forms_exec, plrl, cache, loc, loc_plzr, anchor;',
                      ]),
                      i.push("params = flatten(params);"),
                      p(a, function (e) {
                        if ("literal" !== e.type) {
                          if ("variable" === e.type)
                            return (
                          ...
                          (s = e.anchor),
                            (o = {}),
                            p(e.strict, function (t, a) {
                              var i = r.parse(t);
                              if (1 === i.length && "literal" === i[0].type)
                                return (
                                  (o[a] = !1), void (e.strict[a] = i[0].text)
                                );
                              (o[a] = !0),
                                c.hasPhrase(n, t, !0) || c.addPhrase(n, t, t);
                            }),
                            (l = {}),
                            p(e.forms, function (t, a) {
                              var i,
                                s = r.parse(t);
                            ...
                            i.push(f("loc = %j;", n)),
                            i.push(f("loc_plzr = %j;", n.split(/[-_]/)[0])),
                            i.push(f("anchor = params[%j];", s)),
                            i.push(f("cache = this._plurals_cache[loc];")),
                            i.push(f("strict = %j;", e.strict)),
                            i.push(f("strict_exec = %j;", o)),
                            i.push(f("forms = %j;", e.forms)),
                            i.push(f("forms_exec = %j;", l)),
                            i.push("if (+(anchor) != anchor) {"),
                            i.push(
                              f(
                            ...
                            i.push("} else {"),
                            i.push("  if (strict[anchor] !== undefined) {"),
                            i.push("    plrl = strict[anchor];"),
                            i.push(
                  ...
                  : t;
              })(this, a.translation, a.locale)),
            "[object Function]" !== i(a.compiled)
              ? a.compiled
              : ((o(n) || s(n)) &&
                  (n = {
                    count: n,
      ...
      (E.prototype.t = E.prototype.translate),
        ...
        })(e, Error),
        {
          ...
          parse: function (t) {
            ...
            function ue() {
              var e, t;
              for (
                e = [], (t = ye()) === a && (t = de()) === a && (t = me());
                t !== a;

              )
                e.push(t), (t = ye()) === a && (t = de()) === a && (t = me());
              return e;
            }
            function de() {
              var e, n, r, i, s;
  ...
  function (e, t, n) {
    ...
    function i(e, t) {
      ...
      if (!r[n].cFn) return 0;
      var i = String(t),
        s = i.indexOf(".") < 0 ? "" : i.split(".")[1],
        o = s.length,
        l = +t,
        c = +i.split(".")[0],
        u = 0 === s.length ? 0 : +s.replace(/0+$/, "");
      ...
      c(["az"], {
        ...
        oFn: function (e, t) {
          ...
          return d([1, 2, 5, 7, 8], n) || d([20, 50, 70, 80], r)
            ? 0
            : d([3, 4], n) ||
              d([100, 200, 300, 400, 500, 600, 700, 800, 900], a)
            ? 1
      ...
      c(["bs", "hr", "sh", "sr"], {
        ...
        cFn: function (e, t, n, r) {
          var a = t % 10,
            ...
            s = r % 10,
            o = r % 100;
          return (0 === n && 1 === a && 11 !== i) || (1 === s && 11 !== o)
            ? 0
            : (0 === n && u(2, 4, a) && !u(12, 14, i)) ||
              (u(2, 4, s) && !u(12, 14, o))
            ? 1
            : 2;
        },
      ...
      c(["lv", "prg"], {
        ...
        cFn: function (e, t, n, r) {
          var a = e % 10,
            ...
            s = r % 100,
            o = r % 10;
          return 0 === a || u(11, 19, i) || (2 === n && u(11, 19, s))
            ? 0
            : (1 === a && 11 !== i) ||
              (2 === n && 1 === o && 11 !== s) ||
              (2 !== n && 1 === o)
    ...
    class i {
      ...
      onSwitchClick(e) {
        ...
        for (let a = 0; a < n.length; a++) {
          ...
          i === e.delegateTarget
            ? ((t = a),
              s.classList.add("code-tabs__section_current"),
              i.classList.add("code-tabs__switch_current"))
            : (s.classList.remove("code-tabs__section_current"),
      ...
      highlightTab(e) {
        ...
        Prism.highlightElement(n),
          t.insertAdjacentHTML("afterBegin", a(t.innerHTML)),
          (e.highlighted = !0);
      }
      renderTranslate() {
  ...
  function (e, t, n) {
    ...
    const i = n(1).lang,
      s = n(5);
    s.i18n.add("", n(58)("./" + i + ".yml")),
      s.i18n.add("error.network", n(60)("./" + i + ".yml")),
      ...
      (e.exports = function (e) {
        ...
        let o = a();
        o && !e.skipCsrf && t.setRequestHeader("X-XSRF-TOKEN", o),
  ...
  function (e, t) {
    e.exports = {
      site: {
        ...
        banner_bottom:
          'Advance your skils with <a href="https://frontendmasters.com/learn/javascript/?utm_source=website&utm_medium=jsinfo&utm_campaign=jsinfo">video courses on JavaScript and Frameworks</a>.',
  ...
  function (e, t) {
    ...
    e.exports = function () {
      ...
      for (let t = 0; t < e.length; t++) {
        let r = e[t],
          a = r.dataset.sticky ? JSON.parse(r.dataset.sticky) : {},
          i = a.bottomLimit ? document.querySelector(a.bottomLimit) : null,
          s = a.container ? document.querySelector(a.container) : document.body,
          o = !a.minWidth || document.documentElement.clientWidth > a.minWidth;
        if (r.placeholder)
          (r.placeholder.getBoundingClientRect().top > 0 || !o) &&
            ((r.style.cssText = ""),
            r.classList.remove("sticky"),
            r.placeholder.parentNode.insertBefore(r, r.placeholder),
            r.placeholder.remove(),
            (r.placeholder = null));
        else if (r.placeholder && i)
          i.getBoundingClientRect().top <= r.offsetHeight
            ? ("fixed" == r.style.position &&
                (r.style.top = window.pageYOffset + "px"),
              (r.style.position = "absolute"))
            : ((r.style.position = "fixed"), (r.style.top = 0));
        else if (r.getBoundingClientRect().top < 0 && o) {
          ...
          let i = a.noPlaceholder ? document.createElement("div") : n(r),
            o = r.offsetWidth;
          r.after(i),
            s.appendChild(r),
...
//# sourceMappingURL=tutorial.a2cb726ed10a7d440094.js.map
