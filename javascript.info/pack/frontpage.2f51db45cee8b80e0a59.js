var frontpage = (function (e) {
  ...
  function (e, t, n) {
    ...
    e.exports = s;
    const i = n(0).lang;
    "en" !== i && r.setFallback(i, "en"),
      (r.add = (...e) => r.addPhrase(i, ...e)),
      (s.i18n = r);
  },
  function (e, t, n) {
    "use strict";
  ...
  function (e, t, n) {
    ...
    e.exports = class {
      constructor(e) {
        (this.elem = e),
          (this.renderPromise = new Promise((e, t) => {
      ...
      async validateForm(e) {
        ...
        let t = await this.execute(),
          n = e.elements["g-recaptcha-response"];
        n ||
  ...
  function (e, t, n) {
    ...
    function l(e, t) {
      ...
      let i,
        a = [...n.querySelectorAll("option:checked")].map((e) => e.value);
      if (
        (a.length || (a = n.value),
        e.elements["subscribe-email"] && (i = !0),
        !i && !a.length)
      )
        return void new s.Error(c("newsletter.client.choose_newsletter"));
      const u = {
        email: e.elements.email.value,
        slug: a,
      };
      e.elements["g-recaptcha-response"] &&
        (u["g-recaptcha-response"] = e.elements["g-recaptcha-response"].value),
        i && (u.replace = !0);
      const l = o({
          method: "POST",
          url: e.action,
    ...
    c.i18n.add("newsletter.client", n(24)("./" + u + ".yml")),
      (t.initNewsletterForm = function () {
        let e = document.querySelectorAll("[data-newsletter-subscribe-form]");
        for (let t of e) {
          const e = "hidden" === t.elements.email.type,
            n = t.querySelector(".multiselect");
          if (n) {
            const r = new i({
                elem: n,
              }),
            ...
            t.elements.slug &&
              t.elements.slug.addEventListener("change", () => {
                (o.disabled = !r.getValues().length && !e),
                  !r.getValues().length && e
                    ? (s.textContent = c("site.subscribe.button_unsubscribe"))
                    : (s.textContent = c("site.subscribe.button"));
              });
          }
          let r = new a(t);
  ...
  function (e, t, n) {
    ...
    const s = n(0).lang,
      i = n(1);
    i.i18n.add("", n(16)("./" + s + ".yml")),
      i.i18n.add("error.network", n(18)("./" + s + ".yml")),
  ...
  function (e, t, n) {
    ...
    function _(e, t, n) {
      ...
      for (
        var i, a = e._fallbacks[t] || [e._defaultLocale], c = 0, u = a.length;
        c < u;
        c++
      )
        if (((i = g(a[c], n)), o.hasOwnProperty(i))) return (s[r] = i), s[r];
              ...
              (o.compiled = (function (e, t, n) {
                ...
                return w.test(t)
                  ? 1 === (o = r.parse(t)).length && "literal" === o[0].type
                    ? o[0].text
                    : (e._plurals_cache[n] || (e._plurals_cache[n] = new y(n)),
                      ...
                      p(o, function (e) {
                        if ("literal" !== e.type) {
                          ...
                          (i = e.anchor),
                            (a = {}),
                            p(e.strict, function (t, o) {
                              var s = r.parse(t);
                              if (1 === s.length && "literal" === s[0].type)
                                return (
                                  (a[o] = !1), void (e.strict[o] = s[0].text)
                                );
                              (a[o] = !0),
                                u.hasPhrase(n, t, !0) || u.addPhrase(n, t, t);
                            }),
                            (c = {}),
                            p(e.forms, function (t, o) {
                              var s,
                                i = r.parse(t);
                            ...
                            s.push(h("loc = %j;", n)),
                            s.push(h("loc_plzr = %j;", n.split(/[-_]/)[0])),
                            s.push(h("anchor = params[%j];", i)),
                            s.push(h("cache = this._plurals_cache[loc];")),
                            s.push(h("strict = %j;", e.strict)),
                            s.push(h("strict_exec = %j;", a)),
                            s.push(h("forms = %j;", e.forms)),
                            s.push(h("forms_exec = %j;", c)),
        ...
        })(e, Error),
        {
          ...
          parse: function (t) {
            ...
            function le() {
              var e, t;
              for (
                e = [], (t = be()) === o && (t = fe()) === o && (t = ve());
                t !== o;

              )
                e.push(t), (t = be()) === o && (t = fe()) === o && (t = ve());
              return e;
            }
            function fe() {
              var e, n, r, s, i;
  ...
  function (e, t, n) {
    ...
    function s(e, t) {
      ...
      if (!r[n].cFn) return 0;
      var s = String(t),
        i = s.indexOf(".") < 0 ? "" : s.split(".")[1],
        a = i.length,
        c = +t,
        u = +s.split(".")[0],
        l = 0 === i.length ? 0 : +i.replace(/0+$/, "");
      ...
      u(["az"], {
        ...
        oFn: function (e, t) {
          var n = t % 10,
            r = t % 100,
            o = t % 1e3;
          return f([1, 2, 5, 7, 8], n) || f([20, 50, 70, 80], r)
            ? 0
            : f([3, 4], n) ||
              f([100, 200, 300, 400, 500, 600, 700, 800, 900], o)
            ? 1
            : 0 === t || 6 === n || f([40, 60, 90], r)
            ? 2
            : 3;
        },
      }),
      ...
      u(["bs", "hr", "sh", "sr"], {
        ...
        cFn: function (e, t, n, r) {
          var o = t % 10,
            ...
            i = r % 10,
            a = r % 100;
          return (0 === n && 1 === o && 11 !== s) || (1 === i && 11 !== a)
            ? 0
            : (0 === n && l(2, 4, o) && !l(12, 14, s)) ||
              (l(2, 4, i) && !l(12, 14, a))
            ? 1
            : 2;
        },
      ...
      u(["lv", "prg"], {
        ...
        cFn: function (e, t, n, r) {
          var o = e % 10,
            ...
            i = r % 100,
            a = r % 10;
          return 0 === o || l(11, 19, s) || (2 === n && l(11, 19, i))
            ? 0
            : (1 === o && 11 !== s) ||
              (2 === n && 1 === a && 11 !== i) ||
              (2 !== n && 1 === a)
    ...
    e.exports = class {
      constructor(e) {
        (this.elem = e.elem),
          ...
          (this.textContainer = this.elem.querySelector(
          ...
          (this.status = "closed"),
          this.elem
            .querySelector(".multiselect__container")
            .insertAdjacentHTML("beforeend", this.createDropdown()),
          this.setButtonTitle(),
          this.bindHandlers();
      }
      createDropdown() {
          ...
          this.options
            .map((e) =>
              "<div class='multiselect__item"
                .concat(
                  e.selected ? " multiselect__item_checked" : "",
                  "' data-value='"
                )
                .concat(
                  e.value,
                  "'>\n                <span class='multiselect__item-title'>"
                )
                .concat(
                  e.textContent +
                    ("advanced" === e.value
                      ? "<span class='multiselect__greyed-text'>".concat(
                          r("site.subscribe.common_updates_text"),
                          "</span>"
                        )
                      : ""),
                  "</span>\n              </div>"
      ...
      bindHandlers() {
        ...
        for (let e of this.elem.querySelectorAll(".multiselect__item"))
          e.addEventListener("click", this.onChange.bind(this));
      ...
      closeDropdown(e) {
        e.target.closest(".multiselect__dropdown-container") ||
          ((this.status = "closed"),
      ...
      onChange(e) {
        ...
        (this.options
          .filter((e) => e.value === t.getAttribute("data-value"))
          .pop().selected = t.classList.contains("multiselect__item_checked")),
          this.select.dispatchEvent(new Event("change"));
      }
      setButtonTitle() {
        const e = this.getValues();
        1 === e.length && e.includes("advanced")
          ? (this.textContainer.textContent = this.defaultValue)
          : e.length
          ? (this.textContainer.textContent =
              e.length + " " + o(e.length, r("site.subscribe.newsletters")))
          : (this.textContainer.textContent = r("site.subscribe.no_selected"));
      }
      getValues() {
    ...
    e.exports = async function () {
      ...
      if (e.length) {
        ...
        for (let t of e) {
          ...
          (e.onsubmit = async (t) => {
            t.preventDefault(),
              await n.validateForm(e),
              e.checkValidity() ? e.submit() : e.reportValidity();
          }),
            (t.disabled = !1);
        }
      }
