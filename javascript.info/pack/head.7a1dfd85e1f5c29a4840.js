var head = (function (t) {
      ...
      t.exports = (function () {
        ...
        function b(t, e) {
          ...
          if (
            ...
            for (n = 0; n < w.length; n++) l((i = e[(r = w[n])])) || (t[r] = i);
          return t;
        }
        var M = !1;
        function S(t) {
        ...
        function ct(t, e) {
          return t.isValid()
            ? ((e = dt(e, t.localeData())), (ot[e] = ot[e] || lt(e)), ot[e](t))
        ...
        function dt(t, e) {
          ...
          for (it.lastIndex = 0; n >= 0 && it.test(t); )
            (t = t.replace(it, r)), (it.lastIndex = 0), (n -= 1);
          return t;
        }
        var ht = /\d/,
          ft = /\d\d/,
        ...
        function Xt(t, e) {
          return function (n) {
            return null != n
              ? (te(this, t, n), i.updateOffset(this, e), this)
              : Qt(this, t);
          };
        }
        function Qt(t, e) {
        ...
        function ne(t, e) {
          if ("object" == typeof t)
            for (var n = et((t = X(t))), r = 0; r < n.length; r++)
              this[n[r].unit](t[n[r].unit]);
          else if (A(this[(t = K(t))])) return this[t](e);
          return this;
        }
        function re(t, e) {
          return ((t % e) + e) % e;
        ...
        function ce(t, e, n) {
          ...
          return n
            ? "MMM" === e
              ? -1 !== (i = Bt.call(this._shortMonthsParse, s))
                ? i
                : null
              : -1 !== (i = Bt.call(this._longMonthsParse, s))
              ? i
              : null
            : "MMM" === e
            ? -1 !== (i = Bt.call(this._shortMonthsParse, s)) ||
        ...
        function fe(t) {
          return null != t
            ? (he(this, t), i.updateOffset(this, !0), this)
            : Qt(this, "Month");
        }
        function me() {
        ...
        function pe(t) {
          return this._monthsParseExact
            ? (f(this, "_monthsRegex") || ve.call(this),
              t ? this._monthsShortStrictRegex : this._monthsShortRegex)
            : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = _e),
        ...
        function ge(t) {
          return this._monthsParseExact
            ...
            : (f(this, "_monthsRegex") || (this._monthsRegex = ye),
        ...
        function De(t, e, n) {
          ...
          return (
            s < 1
              ? (r = s + Te((i = t.year() - 1), e, n))
              : s > Te(t.year(), e, n)
              ? ((r = s - Te(t.year(), e, n)), (i = t.year() + 1))
              : ((i = t.year()), (r = s)),
            {
              week: r,
              year: i,
        ...
        function We(t) {
          return !0 === t
            ? Pe(this._weekdaysShort, this._week.dow)
            : t
        ...
        function Re(t) {
          return !0 === t
            ? Pe(this._weekdaysMin, this._week.dow)
            : t
        ...
        function Ue(t, e, n) {
          ...
          return n
            ? "dddd" === e
              ? -1 !== (i = Bt.call(this._weekdaysParse, s))
                ? i
                : null
              : "ddd" === e
              ? -1 !== (i = Bt.call(this._shortWeekdaysParse, s))
                ? i
                : null
              : -1 !== (i = Bt.call(this._minWeekdaysParse, s))
              ? i
              : null
            : "dddd" === e
            ? -1 !== (i = Bt.call(this._weekdaysParse, s)) ||
        ...
        function Ge(t) {
          ...
          return null != t
            ? ((t = Ce(t, this.localeData())), this.add(t - e, "d"))
            : e;
        }
        function Ve(t) {
          if (!this.isValid()) return null != t ? this : NaN;
        ...
        function Je(t) {
          return this._weekdaysParseExact
            ...
            : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = qe),
        ...
        function Ke(t) {
          return this._weekdaysParseExact
            ...
            : (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = $e),
        ...
        function Xe() {
          ...
          for (s.sort(t), a.sort(t), u.sort(t), l.sort(t), e = 0; e < 7; e++)
            (a[e] = At(a[e])), (u[e] = At(u[e])), (l[e] = At(l[e]));
        ...
        at("H", ["HH", 2], 0, "hour"),
          ...
          at("Hmmss", 0, 0, function () {
            return (
              "" + this.hours() + nt(this.minutes(), 2) + nt(this.seconds(), 2)
            );
          }),
          en("a", !0),
          en("A", !1),
        ...
        function fn(t) {
          for (var e, n, r, i, o = 0; o < t.length; ) {
            for (
              e = (i = hn(t[o]).split("-")).length,
                n = (n = hn(t[o + 1])) ? n.split("-") : null;
              e > 0;
        ...
        function pn(t, e) {
          if (null !== e) {
            ...
            if (((e.abbr = t), null != cn[t]))
              ...
              if (null != cn[e.parentLocale]) r = cn[e.parentLocale]._config;
              else {
        ...
        function yn(t, e) {
          if (null != e) {
            var n,
              r,
              i = ln;
            null != (r = mn(t)) && (i = r._config),
              ((n = new N((e = H(i, e)))).parentLocale = cn[t]),
              (cn[t] = n),
              _n(t);
          } else
            null != cn[t] &&
              (null != cn[t].parentLocale
                ? (cn[t] = cn[t].parentLocale)
                : null != cn[t] && delete cn[t]);
          return cn[t];
        }
        function gn(t) {
          var e;
          ...
          return (
            n &&
              ...
              ((e =
                n[jt] < 0 || n[jt] > 11
                  ? jt
                  : n[Rt] < 1 || n[Rt] > ie(n[Wt], n[jt])
                  ? Rt
                  : n[Ut] < 0 ||
                    n[Ut] > 24 ||
                    (24 === n[Ut] &&
                      (0 !== n[It] || 0 !== n[Gt] || 0 !== n[Vt]))
                  ? Ut
                  : n[It] < 0 || n[It] > 59
                  ? It
                  : n[Gt] < 0 || n[Gt] > 59
                  ...
                  ? Vt
                  : -1),
              y(t)._overflowDayOfYear && (e < Wt || e > Rt) && (e = Rt),
              y(t)._overflowWeeks && -1 === e && (e = zt),
              y(t)._overflowWeekday && -1 === e && (e = qt),
              (y(t).overflow = e)),
            t
          );
        }
        ...
        function Sn(t) {
          ...
          if (!t._d) {
            for (
              r = Mn(t),
                t._w && null == t._a[Rt] && null == t._a[jt] && Dn(t),
                null != t._dayOfYear &&
                  ((o = bn(t._a[Wt], r[Wt])),
            ...
            24 === t._a[Ut] &&
              ...
              (t._d = (t._useUTC ? be : we).apply(null, s)),
        ...
        function Dn(t) {
          ...
          if (null != (e = t._w).GG || null != e.W || null != e.E)
            (o = 1),
              (s = 4),
              (n = bn(e.GG, t._a[Wt], De(Bn(), 1, 4).year)),
              (r = bn(e.W, 1)),
              ((i = bn(e.E, 1)) < 1 || i > 7) && (u = !0);
          else {
            (o = t._locale._week.dow), (s = t._locale._week.doy);
            var l = De(Bn(), o, s);
            (n = bn(e.gg, t._a[Wt], l.year)),
              (r = bn(e.w, l.week)),
              null != e.d
                ? ((i = e.d) < 0 || i > 6) && (u = !0)
                : null != e.e
        ...
        function On(t) {
          var e,
            ...
            s,
            a = t._i,
            u = Tn.exec(a) || kn.exec(a);
          if (u) {
            for (y(t).iso = !0, e = 0, n = Ln.length; e < n; e++)
              if (Ln[e][1].exec(u[1])) {
                (i = Ln[e][0]), (r = !1 !== Ln[e][2]);
                break;
              }
        ...
        function Nn(t, e, n) {
          return (
            !t ||
            Fe.indexOf(t) === new Date(e[0], e[1], e[2]).getDay() ||
          ...
          if (t._f !== i.ISO_8601)
            if (t._f !== i.RFC_2822) {
              ...
              var e,
                ...
                l = 0;
              for (
                r = dt(t._f, t._locale).match(rt) || [], e = 0;
                e < r.length;
                e++
              )
                (o = r[e]),
                  (n = (a.match(Ot(o, t)) || [])[0]) &&
                    ((s = a.substr(0, a.indexOf(n))).length > 0 &&
                      y(t).unusedInput.push(s),
                    (a = a.slice(a.indexOf(n) + n.length)),
                    (l += n.length)),
                  st[o]
                    ? (n ? (y(t).empty = !1) : y(t).unusedTokens.push(o),
                      Ft(o, n, t))
                    : t._strict && !n && y(t).unusedTokens.push(o);
              (y(t).charsLeftOver = u - l),
                ...
                (t._a[Ut] = In(t._locale, t._a[Ut], t._meridiem)),
                Sn(t),
                wn(t);
            } else jn(t);
          else On(t);
          ...
          return (
            ...
            null === e || (void 0 === n && "" === e)
              ...
              : ("string" == typeof e && (t._i = e = t._locale.preparse(e)),
                D(e)
                  ? new S(wn(e))
                  : (d(e) ? (t._d = e) : s(n) ? Gn(t) : n ? Un(t) : Jn(t),
                    g(t) || (t._d = null),
                    t))
          );
        }
        ...
        function Zn(t, e, n, r, i) {
          ...
          return (
            ...
            ((a(t) && u(t)) || (s(t) && 0 === t.length)) && (t = void 0),
        ...
        function rr(t) {
          for (var e in t)
            if (-1 === Bt.call(nr, e) || (null != t[e] && isNaN(t[e])))
              return !1;
        ...
        function dr(t, e) {
          ...
          var r = ((n[n.length - 1] || []) + "").match(cr) || ["-", 0, 0],
            i = 60 * r[1] + k(r[2]);
        ...
        function hr(t, e) {
          ...
          return e._isUTC
            ? ((n = e.clone()),
              (r =
                (D(t) || d(t) ? t.valueOf() : Bn(t).valueOf()) - n.valueOf()),
        ...
        function mr(t, e, n) {
          ...
          if (null != t) {
            ...
            return (
              !this._isUTC && e && (r = fr(this)),
              (this._offset = t),
              (this._isUTC = !0),
              null != r && this.add(r, "m"),
              o !== t &&
                (!e || this._changeInProgress
                  ? Cr(this, Yr(t - o, "m"), 1, !1)
        ...
        function vr(t) {
          return (
            !!this.isValid() &&
            ((t = t ? Bn(t).utcOffset() : 0), (this.utcOffset() - t) % 60 == 0)
          );
        }
        function wr() {
          return (
        ...
        function Yr(t, e) {
          ...
          return (
            ar(t)
              ...
              : "object" == typeof o &&
                ("from" in o || "to" in o) &&
                ((i = xr(Bn(o.from), Bn(o.to))),
                ((o = {}).ms = i.milliseconds),
                (o.M = i.months)),
            (r = new sr(o)),
            ar(t) && f(t, "_locale") && (r._locale = t._locale),
            r
          );
        }
        function Lr(t, e) {
        ...
        function xr(t, e) {
          ...
          return t.isValid() && e.isValid()
            ? ((e = hr(e, t)),
              t.isBefore(e)
                ? (n = Er(t, e))
                : (((n = Er(e, t)).milliseconds = -n.milliseconds),
                  (n.months = -n.months)),
              n)
            : {
                milliseconds: 0,
          ...
          return function (n, r) {
            ...
            return (
              null === r ||
                ...
                (n = r),
                (r = i)),
              Cr(this, Yr((n = "string" == typeof n ? +n : n), r), t),
              this
            );
          };
        }
        function Cr(t, e, n, r) {
          ...
          t.isValid() &&
            ((r = null == r || r),
            a && he(t, Qt(t, "Month") + a * n),
            s && te(t, "Date", Qt(t, "Date") + s * n),
        ...
        function Vr(t, e, n) {
          ...
          switch (
            ((i = 6e4 * (r.utcOffset() - this.utcOffset())), (e = K(e)))
          ) {
            case "year":
              o = zr(this, r) / 12;
              break;
        ...
        function $r(t, e) {
          return this.isValid() && ((D(t) && t.isValid()) || Bn(t).isValid())
            ? Yr({
                to: this,
                from: t,
              })
        ...
        function ci(t) {
          var e;
          if (void 0 === (t = K(t)) || "millisecond" === t || !this.isValid())
            return this;
          ...
          switch (t) {
            ...
            case "hour":
              (e = this._d.valueOf()),
                (e -= ai(e + (this._isUTC ? 0 : this.utcOffset() * ii), oi));
              break;
          ...
          switch (t) {
            ...
            case "hour":
              (e = this._d.valueOf()),
                (e +=
                  oi -
                  ai(e + (this._isUTC ? 0 : this.utcOffset() * ii), oi) -
                  1);
              break;
        ...
        function Yi(t, e, n, r, i) {
          ...
          return null == t
            ? De(this, r, i).year
            : (e > (o = Te(t, r, i)) && (e = o), Li.call(this, t, e, n, r, i));
        }
        function Li(t, e, n, r, i) {
          var o = Se(t, e, n, r, i),
            s = be(o.year, 0, o.dayOfYear);
          return (
        ...
        for (
          at("S", 0, 0, function () {
            ...
            at(0, ["SSS", 3], 0, "millisecond"),
            at(0, ["SSSS", 4], 0, function () {
        ...
        (ji.add = Ar),
          ...
          (ji.weekYear = Si),
          (ji.isoWeekYear = Di),
          (ji.quarter = ji.quarters = Ei),
          (ji.month = fe),
          (ji.daysInMonth = me),
          (ji.week = ji.weeks = xe),
          (ji.isoWeek = ji.isoWeeks = Oe),
          (ji.weeksInYear = ki),
          (ji.isoWeeksInYear = Ti),
          (ji.date = xi),
          (ji.day = ji.days = Ge),
          (ji.weekday = Ve),
          (ji.isoWeekday = ze),
          (ji.dayOfYear = Oi),
          (ji.hour = ji.hours = un),
          (ji.minute = ji.minutes = Ci),
          (ji.second = ji.seconds = Pi),
          (ji.millisecond = ji.milliseconds = Ni),
          (ji.utcOffset = mr),
          (ji.utc = pr),
          (ji.local = yr),
          (ji.parseZone = gr),
          (ji.hasAlignedHourOffset = vr),
          (ji.isDST = wr),
          (ji.isLocal = Mr),
          (ji.isUtcOffset = Sr),
          (ji.isUtc = Dr),
          ...
          (ji.zoneAbbr = Fi),
          (ji.zoneName = Wi),
          (ji.dates = E("dates accessor is deprecated. Use date instead.", xi)),
          (ji.months = E(
            "months accessor is deprecated. Use month instead",
            fe
          )),
          (ji.years = E("years accessor is deprecated. Use year instead", $t)),
          (ji.zone = E(
        ...
        (Gi.calendar = W),
          ...
          (Gi.monthsParse = de),
          (Gi.monthsRegex = ge),
          (Gi.monthsShortRegex = pe),
          (Gi.week = ke),
          (Gi.firstDayOfYear = Ee),
          (Gi.firstDayOfWeek = Le),
          (Gi.weekdays = Ne),
          (Gi.weekdaysMin = Re),
          (Gi.weekdaysShort = We),
          (Gi.weekdaysParse = Ie),
          (Gi.weekdaysRegex = Je),
          (Gi.weekdaysShortRegex = Be),
          (Gi.weekdaysMinRegex = Ke),
          (Gi.isPM = rn),
          (Gi.meridiem = sn),
          _n("en", {
        ...
        function ao(t) {
          ...
          if ("month" === (t = K(t)) || "quarter" === t || "year" === t)
            switch (
              ((e = this._days + r / 864e5), (n = this._months + oo(e)), t)
            ) {
              case "month":
                return n;
        ...
        function Ro() {
          ...
          if (!d) return "P0D";
          var h = d < 0 ? "-" : "",
            f = jo(this._months) !== jo(d) ? "-" : "",
            m = jo(this._days) !== jo(d) ? "-" : "",
            _ = jo(this._milliseconds) !== jo(d) ? "-" : "";
          return (
            h +
            "P" +
            (o ? f + o + "Y" : "") +
        ...
        return (
          ...
          (i.weekdaysShort = $i),
          (i.normalizeUnits = K),
          (i.relativeTimeRounding = Ho),
          (i.relativeTimeThreshold = No),
          (i.calendarFormat = Hr),
          (i.prototype = ji),
          (i.HTML5_FMT = {
  ...
  function (t, e) {
    ...
    t.exports = function () {
      ...
      return (
        e[0].match(/[+-]/)
          ? (e = e[0])
          : e[e.length - 1].match(/[+-]/) || e[e.length - 1].match(/[A-Z]{2,}/)
          ? (e = e[e.length - 1])
          : ((e = "GMT"),
            t > 0 && (e += "+" + t / 60),
            t < 0 && (e += "-" + -t / 60)),
  ...
  function (t, e) {
    t.exports = {
      ...
      stripeKey:
        "pk_live_51HXm0nFjeNqw1p5a3mjFxSeNHh8OL94IyGcp3PHbZVoNuYUYjlM57YtZMIAM1zrEd1F6WIKfFs67KbTemRdNIySo00KfWS1yhr",
    ...
    if (
      ...
      let t = {
        ...
        get: function () {
          ...
          for (t = 0; t < u; t++)
            if (((o = a[t]), o && o.name && /^data-\w[\w\-]*$/.test(o.name))) {
  ...
  function (t, e) {
    (function () {
      ...
      var g = window.Document.prototype.createElement,
        ...
        b = window.Document.prototype.prepend,
        M = window.Document.prototype.append,
        S = window.DocumentFragment.prototype.prepend,
        D = window.DocumentFragment.prototype.append,
        T = window.Node.prototype.cloneNode,
        k = window.Node.prototype.appendChild,
        Y = window.Node.prototype.insertBefore,
        L = window.Node.prototype.removeChild,
        E = window.Node.prototype.replaceChild,
        ...
        R = window.Element.prototype.insertAdjacentHTML,
        ...
        B = window.HTMLElement.prototype.insertAdjacentElement,
        ...
        (Q = et),
          (window.HTMLElement = (function () {
            function t() {
              ...
              return (
                (n[e] = K), Object.setPrototypeOf(r, t.prototype), u(Q, r), r
              );
            }
            return (
          ...
          (function () {
            ...
            o(Node.prototype, "insertBefore", function (t, r) {
              ...
              o(Node.prototype, "replaceChild", function (t, r) {
                if (t instanceof DocumentFragment) {
                  var i = Array.prototype.slice.apply(t.childNodes);
                  if (((t = E.call(this, t, r)), n(this)))
                    for (c(e, r), r = 0; r < i.length; r++) l(e, i[r]);
                  return t;
                }
                i = n(t);
                var o = E.call(this, t, r),
                  s = n(this);
                ...
                : (function (t, e) {
                    ...
                    t(e, {
                      ...
                      set: function (t) {
                        ...
                        null != t &&
                          "" !== t &&
                          k.call(this, document.createTextNode(t));
                      },
                    });
                  });
          })(),
          (function () {
            ...
            O &&
              ...
              C && C.get
                ? t(Element.prototype, C)
                : Z && Z.get
                ? t(HTMLElement.prototype, Z)
                : (function (t, e) {
                    (t.b = !0), t.f.push(e);
                  })(s, function (e) {
                    t(e, {
              ...
              B ? e(HTMLElement.prototype, B) : j && e(Element.prototype, j),
              $ ? r(HTMLElement.prototype, $) : R && r(Element.prototype, R),
              ...
              (function (t) {
                ...
                void 0 !== G && (r.before = e(G)),
                  void 0 !== G && (r.after = e(V)),
                  void 0 !== z &&
    ...
    (n(2).inspectSource = function (t) {
      ...
      (t.exports = function (t, e, n, a) {
        ...
        u && (o(n, "name") || i(n, "name", e)),
          t[e] !== n &&
            (u && (o(n, s) || i(n, s, t[e] ? "" + t[e] : l.join(String(e)))),
            t === r
              ? (t[e] = n)
              : a
              ? t[e]
  ...
  function (t, e, n) {
    ...
    for (let t of document.querySelectorAll("[data-action-login]"))
      for (let e of t.classList)
        e.endsWith("_unready") && t.classList.remove(e);
    function i(t) {
      let e = new Modal({
          hasClose: !1,
  ...
  function (t, e, n) {
    const r = n(12).loadDisqus,
      i = n(12).loadDisqusComments,
      o = n(12).loadDisqusIfVisible;
    let s;
    function a() {
      false;
    }
    function u() {
      a("onWindowScrollAndResizeThrottled", s),
        s ||
            ...
            !(function () {
              ...
              if (n) {
                const t = document.querySelector(".page"),
                  r =
                    t.classList.contains("page_profile") &&
                    "flex" === getComputedStyle(t).display
                      ? 0
                      : Math.max(e.getBoundingClientRect().bottom, 0) + "px";
                (n.style.top = r),
                  (function () {
                    a("compactifySidebar");
                    ...
                    if (t.classList.contains("sidebar_compact")) {
                      ...
                      a(n.scrollHeight, n.clientHeight),
                        n.scrollHeight > n.clientHeight &&
                          (a("compact!"), t.classList.add("sidebar_compact"));
                  })();
              }
              (function () {
                let t = document.documentElement.clientWidth <= 840,
  ...
  function (t, e) {
    document.addEventListener("click", function (t) {
      ...
      t.target.closest(".sitetoolbar__search-toggle") &&
        (n ||
          (function () {
            let t,
              e = document.querySelector(r),
              o = e.querySelector(".sitetoolbar__search-input input");
    ...
    function i() {
      ...
      e.classList.contains("sitetoolbar_search_open")
        ? (n.focus(),
          (t = document.createElement("div")),
          (t.className = "search-paranja"),
          (t.style.top = e.offsetHeight + "px"),
          document.body.appendChild(t),
          document.body.classList.add("paranja-open"))
        : ((t = document.querySelector(".search-paranja")),
    ...
    class o extends HTMLElement {
      ...
      render() {
        ...
        if (((this.lastParams = t), this.hasAttribute("with-zone"))) {
          ...
          this.setAttribute(
            "data-tooltip",
            "Время в вашем часовом поясе,<br>по данным браузера это " + t
          );
        }
        ...
        let n = new Date(this.getAttribute("from")),
          ...
          s = this.getAttribute("format");
        n.getFullYear() === r.getFullYear() &&
          (o = o.replace(/ YY(YY)?$/g, "")),
          (n.getFullYear() === r.getFullYear() &&
            n.getMonth() === r.getMonth() &&
            n.getDate() === r.getDate()) ||
            e.push(this.format(n, o)),
          e.push(this.format(r, s, this.hasAttribute("with-zone"))),
  ...
  function (t, e, n) {
    ...
    class a extends HTMLElement {
      ...
      render() {
        ...
        this.lastParams = t;
        let e,
          n = this.getAttribute("weekdays").split(",").map(Number),
...
//# sourceMappingURL=head.7a1dfd85e1f5c29a4840.js.map
